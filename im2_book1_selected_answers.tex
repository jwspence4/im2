...
\item Translate the graph 2 to the right. Translate it down 5. Dilate it by a factor of 3.
...
\item $25 = (x + 3)^2 + (y + 1)^2$. No.

\item $r^2 = (x - h)^2 + (y - k)^2$
